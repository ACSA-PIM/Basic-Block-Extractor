...
def mpiProcess(task,wait2endQueue,rank):
...
if __name__ == "__main__":
    ...
    rawTaskNum=17
    rawTaskNamePrefix="Gzip_"
    rawTaskPathPrefix="/home/shaojiemike/Download/Gzip_"
    for i in range(rawTaskNum):
        rawTaskName="{}{:02d}".format(rawTaskNamePrefix,i)
        rawTaskPath="{}{:02d}".format(rawTaskPathPrefix,i)
        task[rawTaskName]=rawTaskPath
    ...
    for i in range(ProcessNum):
        ...
        p = Process(target=mpiProcess, args=(mpiTask,wait2endQueue,i))
        p.start()
